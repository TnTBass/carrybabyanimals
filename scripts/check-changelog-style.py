#!/usr/bin/env python3
"""Require public release notes to be written for players and server admins."""
...
DEVELOPMENT_LOG_PATTERNS = [
    ...
    (re.compile(r"\bPayload\b"), "network implementation detail"),
    (re.compile(r"\bServerPlayNetworking\b"), "network implementation detail"),
    (re.compile(r"\bClientPlayNetworking\b"), "network implementation detail"),
    (re.compile(r"\bcapability-gated\b", re.IGNORECASE), "network implementation detail"),
