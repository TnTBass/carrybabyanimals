...
function Test-ModrinthUploadEnforcesRequiredServerOptionalClient {
    ...
    Assert-Contains $script '$_.version_number -eq $modrinthVersionNumber -and $_.loaders -contains $Loader' 'Modrinth upload must skip only an already-created release row for the same loader.'
